...
# author: "Dini Kristianti (kristian.dini01@gmail.com)"
...
shinyUI(fluidPage(theme = shinytheme("flatly"),
                  ...
                  navbarPage("NYC Flights",
                             # s : menu 1 --
                             tabPanel(icon("home"),
                                      h3("dinikristianti.shinyapps.io"),
                                      fluidRow(column(12,tags$img(src="pesawat.jpg",width="960px",height="540px",class="img-responsive"),align="center")
                                      ),
                                      fluidRow(column(12,
                                                      uiOutput("homefile"),
                                                     align="left"),
                             ...
                             # s : menu 5 --
                            # tabPanel("Flight",
                               #       h3("hubungan antara jarak dan penundaan rata-rata untuk setiap lokasi."),
                                #      hr(),
